...
namespace ToonVS
{
    ...
    /// document outline support for Toon files in the Document Outline tool window.
    /// </summary>
    [ComVisible(true)]
    internal class ToonCodeWindowManager : CodeWindowManager, IVsDocOutlineProvider
    {
        ...
        public ToonCodeWindowManager(
            LanguageService languageService,
            IVsCodeWindow codeWindow,
            Source source,
            IWpfTextView textView,
            Document document)
            : base(languageService, codeWindow, source)
        {
            _textView = textView;
            _document = document;
        }
